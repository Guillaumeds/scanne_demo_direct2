  ...
  public: {
    Tables: {
      ...
      operation_labour: {
        ...
        Relationships: [
          {
            foreignKeyName: "operation_labour_field_operation_uuid_fkey"
            columns: ["field_operation_uuid"]
            isOneToOne: false
            referencedRelation: "field_operations"
            referencedColumns: ["uuid"]
          ...
          {
            foreignKeyName: "operation_labour_labour_uuid_fkey"
            columns: ["labour_uuid"]
            isOneToOne: false
      ...
      work_package_equipment: {
        Row: {
          ...
          actual_hours: number | null
          created_at: string | null
          daily_work_package_uuid: string
          equipment_uuid: string
          planned_cost: number
          planned_hours: number
          updated_at: string | null
      ...
      work_package_labour: {
        ...
        Relationships: [
          {
            foreignKeyName: "work_package_labour_daily_work_package_uuid_fkey"
            columns: ["daily_work_package_uuid"]
            isOneToOne: false
            referencedRelation: "daily_work_packages"
            referencedColumns: ["uuid"]
          ...
          {
            foreignKeyName: "work_package_labour_labour_uuid_fkey"
            columns: ["labour_uuid"]
            isOneToOne: false
            referencedRelation: "labour"
            referencedColumns: ["id"]
