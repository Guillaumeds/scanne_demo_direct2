  ...
  public: {
    Tables: {
      ...
      blocs: {
        ...
        Relationships: [
          {
            foreignKeyName: "blocs_field_id_fkey"
            columns: ["field_id"]
            isOneToOne: false
      ...
      companies: {
        Row: {
          ...
          created_at: string | null
          headquarters_location: unknown | null
          id: string
          metadata: Json | null
          name: string
      ...
      crop_cycles: {
        Row: {
          ...
          id: string
          intercrop_actual_harvest_date: string | null
          intercrop_actual_yield_tons_ha: number | null
          intercrop_planned_harvest_date: string | null
          ...
          sugarcane_planned_harvest_date: string
          sugarcane_planting_date: string | null
          sugarcane_revenue: number | null
          sugarcane_variety_id: string
      ...
      field_analytics_history: {
        ...
        Relationships: [
          {
            foreignKeyName: "field_analytics_history_field_id_fkey"
            columns: ["field_id"]
            isOneToOne: false
            referencedRelation: "fields"
            referencedColumns: ["id"]
      ...
      fields: {
        Row: {
          aggregated_analytics: Json | null
          area_hectares: number
          coordinates: unknown
          created_at: string | null
          farm_id: string
